...
/// @nodoc
mixin _$SearchState {
  List<SerchResultData> get searchResultList =>
      throw _privateConstructorUsedError;
...
abstract class $SearchStateCopyWith<$Res> {
  ...
  @useResult
  $Res call(
      {List<SerchResultData> searchResultList,
...
class _$SearchStateImpl implements _SearchState {
  _$SearchStateImpl(
      {required final List<SerchResultData> searchResultList,
  ...
  final List<SerchResultData> _searchResultList;
  @override
  List<SerchResultData> get searchResultList {
