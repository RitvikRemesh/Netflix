...
class VideoListItem extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    ...
    return Stack(
      children: [
        FastLaughVideoPlayer(videoUrl: videoUrl, onStateChnaged: (bool) {}),
        Align(
...
class FastLaughVideoPlayer extends StatefulWidget {
  ...
  const FastLaughVideoPlayer({
    ...
    required this.onStateChnaged,
  });

  @override
  State<FastLaughVideoPlayer> createState() => _FastLaughViedoPlayerState();
}

class _FastLaughViedoPlayerState extends State<FastLaughVideoPlayer> {
